...
type Review struct {
	...
	Violation         string                 `protobuf:"bytes,10,opt,name=violation,proto3" json:"violation,omitempty"`
...
func (x *Review) GetViolation() string {
	if x != nil {
		return x.Violation
	}
	return ""
...
const file_sharedpb_shared_proto_rawDesc = "" +
	"\n" +
	"\x15sharedpb/shared.proto\x12\bsharedpb\"\xae\x02\n" +
	"\x06Review\x12\x0e\n" +
	...
	"\rresponse_text\x18\t \x01(\tR\fresponseText\x12\x1c\n" +
	"\tviolation\x18\n" +
	" \x01(\tR\tviolationB7Z5github.com/bushnelljw-git/protos/go/sharedpb;sharedpbb\x06proto3"
